...
#define  PULSE1_VALUE       (uint32_t)(PERIOD_VALUE*0.2)        /* Capture Compare 1 Value  */
#define  PULSE2_VALUE       (uint32_t)(PERIOD_VALUE*0.2) /* Capture Compare 2 Value  */
/* USER CODE END PTD */
...
static void MX_I2C1_Init(void)
{
  ...
  hi2c1.Init.OwnAddress1 = 0x3C;//0x70 << 1;
